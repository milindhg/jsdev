...
Solution:   The first logic is to form array and run the bitwise check to find
out number of 1s in the binary representation of each number as we traverse from
...
formed for the number of 1s in the binary representation of numbers as below
